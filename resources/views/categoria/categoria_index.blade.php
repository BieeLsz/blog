        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                ...
                <div class="d-flex justify-content-center m-3">
                    <a href="{{ url('/categoria/create') }}" class="btn btn-success btn-lg" role="button"
                    ...
                    @foreach ($categorias as $value)
                        <tr>
                            ...
                            <td class="d-flex justify-content-around">
                                <a href="{{ url('/categoria/' . $value->id) }}" class="btn btn-primary btn-sm"
                                    role="button" aria-disabled="true">Visualizar</a>

                                <a href="{{ url('/categoria/' . $value->id) . '/edit' }}" class="btn btn-warning btn-sm"
